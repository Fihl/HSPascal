 ...
 *  the module :Libraries:PalmOS:Src:StdIOPalm.c. This module provides a PilotMain
 * that extracts the command line arguments from the cmd and
...
typedef  Int16 (*SioMainProcPtr)(UInt16 argc, Char * argv[]);
 ...
 ********************************************************************/
  ...
  SioGlobalsptr = ^SioGlobalsType;
  SioGlobalsType = Record
